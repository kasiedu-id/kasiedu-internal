              ...
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <div
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${(pathname === "/sponsors" ||
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <a
                              href={`/sponsors?${query}`}
                              className={`first-letter:group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${pathname === "/sponsors" &&
                                "text-white"
                                }`}
                            >
                              List
                          ...
                          <li>
                            <a
                              href={`/sponsors/archive?${query}`}
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${pathname === "/sponsors/archive" &&
                                "text-white"
                                }`}
                            >
                              Archive
