...
import { recoveryDeleteClass } from "../../../../config/api/services/classes";
function RecoveryClassModal({ open, onCancel, name, id, onAccept }) {
    async function submit(){
        try {
            await recoveryDeleteClass({
                id
            });
          ...
          <div className="mt-3">
            ...
            <div className="mt-2 py-3">
              <p className="text-sm text-gray-500 text-center">
                Are you sure want to recovery this ?
              </p>
            </div>
  ...
  export default RecoveryClassModal;
