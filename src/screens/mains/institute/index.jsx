...
function InstitutePage() {
    ...
    return (
        <>
            ...
            <div className={`max-h-[80vh] w-full flex flex-col md:grid md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-5 md:gap-2 ${data.length > 0 ? '' : 'justify-center items-center'}`}>
                {
